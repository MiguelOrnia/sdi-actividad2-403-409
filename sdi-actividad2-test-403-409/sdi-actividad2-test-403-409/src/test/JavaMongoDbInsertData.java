...
public class JavaMongoDbInsertData {
	...
	public void insertOneDataTest() throws ParseException {
		try {
			...
			col.insertOne(new Document().append("name", "Miguel")
			...
			col.insertOne(new Document().append("name", "Alfredo")
					...
					.append("money", 100)
					.append("rol", "rol_estandar"));
			col.insertOne(new Document().append("name", "Paco")
					...
					.append("money", 100)
					.append("rol", "rol_estandar"));
			col.insertOne(new Document().append("name", "Maria")
					...
					.append("money", 100)
					.append("rol", "rol_estandar"));
			col.insertOne(new Document().append("name", "Alvaro")
					...
					.append("money", 100)
					.append("rol", "rol_estandar"));
			col.insertOne(new Document().append("name", "admin")
					.append("surname", "")
			...
			col.insertOne(new Document()
					...
					.append("price", "100")
					.append("buyer", "paco@email.com")
					.append("seller", "miguel@email.com"));
			col.insertOne(new Document()
					.append("title", "Consola")
					.append("details", "Vendo Play Station 5")
					.append("price", "500")
					.append("seller", "alfredo@email.com"));
			col.insertOne(new Document()
					.append("title", "Raton")
					.append("details", "Vendo raton de ordenador")
					.append("price", "50")
					.append("seller", "paco@email.com"));
			col.insertOne(new Document()
			...
			col.insertOne(new Document()
					...
					.append("price", "80")
					.append("seller", "maria@email.com"));
			col.insertOne(new Document()
					.append("title", "Gafas")
					.append("details", "Vendo gafas")
					.append("price", "2500")
					.append("buyer", "miguel@email.com")
					.append("seller", "maria@email.com"));
			col.insertOne(new Document()
			...
			col.insertOne(new Document()
					...
					.append("details", "En perfecto estado")
					.append("price", "4560.2")
					.append("seller", "alvaro@email.com"));
			col.insertOne(new Document()
